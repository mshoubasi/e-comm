                ...
                <div class="row">
                    <div class="col-lg-9">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $pageSize == 12 ? 'active' : '' }}" href="#"
                                                    wire:click.prevents='changePageSize(12)'>12</a></li>
                                            <li><a class="{{ $pageSize == 15 ? 'active' : '' }}" href="#"
                                                    wire:click.prevents='changePageSize(15)'>15</a></li>
                                            <li><a class="{{ $pageSize == 25 ? 'active' : '' }}" href="#"
                                                    wire:click.prevents='changePageSize(25)'>25</a></li>
                                            <li><a class="{{ $pageSize == 32 ? 'active' : '' }}" href="#"
                                                    wire:click.prevents='changePageSize(32)'>32</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'Default Sorting' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevents="changeOrderBy('Default Sorting')">Default
                                                    Sorting</a></li>
                                            <li><a class="{{ $orderBy == 'Price: Low to High' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevents="changeOrderBy('Price: Low to High')">Price: Low
                                                    to High</a></li>
                                            <li><a class="{{ $orderBy == 'Price: High to Low' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevents="changeOrderBy('Price: High to Low')">Price:
                                                    High to Low</a></li>
                                            <li><a class="{{ $orderBy == 'Sort By Newest' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevents="changeOrderBy('Sort By Newest')">Sort By
                                                    Newest</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="row product-grid-3">
                            @php
                                $wishlist_items = Cart::instance('wishlist')
                                    ->content()
                                    ->pluck('id');
                            @endphp
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a
                                                    href="{{ route('product.category', ['slug' => $product->slug]) }}">{{ $product->category->name }}</a>
                                            </div>
                                            <h2><a
                                            ...
                                            <div class="product-action-1 show">
                                                @if ($wishlist_items->contains($product->id))
                                                    <a aria-label="Remove From Wishlist"
                                                        ...
                                                        wire:click.prevents='removeFromWishList({{ $product->id }})'><i
                                                            class="fi-rs-heart"></i></a>
                                                @else
                                                    <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                                        href="#" wire:click="$refresh"
                                                        wire:click.prevents="addToWishList( {{ $product->id }}, '{{ $product->name }}', {{ $product->regular_price }} )"><i
                                                            class="fi-rs-heart"></i></a>
                                                @endif
                                                <a aria-label="Add To Cart" class="action-btn hover-up" href="#"
                                                    wire:click.prevents="store( {{ $product->id }}, '{{ $product->name }}' ,{{ $product->regular_price }} )"><i
