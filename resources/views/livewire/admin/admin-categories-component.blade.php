                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            <td><img src="{{ asset('assets/imgs/category/') }}/{{ $category->image }}"
                                                    alt="{{ $category->name }}" width="60"></td>
                                            <td>{{ $category->name }}</td>
                                            <td>{{ $category->slug }}</td>
                                            <td>{{ $category->is_popular == 1 ? 'Yes':'No' }}</td>
                                            <td> <a href="{{ route('admin.category.edit', ['category_id' => $category->id]) }}"
            ...
            <div class="modal-body pb-30 pt-30">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <button type="submit" onclick="deleteCategory()" class="btn btn-danger">Delete</button>
                    </div>
                </div>
            </div>
        </div>
